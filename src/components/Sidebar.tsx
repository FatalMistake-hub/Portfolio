...
import { isMobile, useClickOutside } from "@/lib/utils";
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className={`px-6 z-[100] pt-12 pb-10 bg-neutral-100 max-w-[14rem] lg:w-fit fixed lg:relative h-screen left-0 flex flex-col justify-between`}
            ref={ref}
          >
