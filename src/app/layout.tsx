...
export const metadata: Metadata = {
    ...
    authors: [
        { name: "Minh Nhat", url: "https://portfolio-rho-jet-91.vercel.app" },
    ],
    creator: "Minh Nhat",
    publisher: "Minh Nhat",
    robots: {
        ...
        <html lang="en">
            <head>
                ...
                <meta
                    ...
                    content="2x3KQk18neDmpdtVWTsMxh4BpyiRQtx16ZizkXzNZ-U"
                />
            ...
            >
                <ThemeProvider>
                    <Sidebar />
                    <div
                        className="lg:pl-2 lg:pt-2
                    dark:bg-gray-900 bg-gray-100 flex-1 overflow-y-auto"
                    >
                        <div
                            className="relative flex-1 bg-white min-h-screen lg:rounded-tl-xl border border-transparent lg:border-neutral-200 overflow-y-auto  
                        dark:bg-gray-800
                        dark:lg:border-neutral-700 overflow"
                        >
                            {children}
                            <SpeedInsights />
                            <Footer />
